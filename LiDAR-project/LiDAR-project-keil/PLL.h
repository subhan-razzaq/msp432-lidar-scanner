...
#define PSYSDIV 9
// UPDATE: In PLL.c MINT was changed to 68 so that the fVCO is 340 MHz, thus for SysClk 34 MHz, PSYDEV value 9 is needed
// UPDATE: bus frequency is 340MHz/(PSYSDIV+1) = 340MHz/(9+1) = 34 MHz
...
PSYSDIV  SysClk (Hz)
  ...
  5      80,000,000
  7      60,000,000
  9      48,000,000   9   34,000,000 for fVCO 340MHz
 15      30,000,000
 19      24,000,000
 29      16,000,000
 39      12,000,000
